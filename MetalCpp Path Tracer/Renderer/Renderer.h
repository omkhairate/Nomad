...
private:
  ...
  MTL::Buffer *_pSphereStagingBuffer = nullptr;
  MTL::Buffer *_pSphereMaterialStagingBuffer = nullptr;
  MTL::Buffer *_pTriangleVertexStagingBuffer = nullptr;
  MTL::Buffer *_pTriangleIndexStagingBuffer = nullptr;
  MTL::Buffer *_pBVHStagingBuffer = nullptr;
  MTL::Buffer *_pPrimitiveIndexStagingBuffer = nullptr;
  MTL::Buffer *_pTLASStagingBuffer = nullptr;
  MTL::Buffer *_pActiveStagingBuffer = nullptr;
  MTL::Buffer *_pPrimitiveRemapStagingBuffer = nullptr;
  MTL::Buffer *_pLightIndexStagingBuffer = nullptr;
  MTL::Buffer *_pLightCdfStagingBuffer = nullptr;
  uint64_t _pendingUploads = 0;
