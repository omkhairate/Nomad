...
kernel void pathTraceKernel(
    ...
    device const PackedMaterial *materials [[buffer(2)]],
    ...
    device const PackedLight *lights [[buffer(9)]],
    device const LightAliasEntry *lightAlias [[buffer(10)]],
  ...
  for (uint sampleIdx = 0; sampleIdx < samplesThisFrame; ++sampleIdx) {
    ...
    PathTraceSample sample = rayColor(r, rayDx, rayDy, tlasNodes, u.tlasNodeCount,
                                      ...
                                      activeMask, instanceRecords, lights,
                                      lightAlias, primitiveRemap, primitiveHitCounts,
